...
import { Card, CardImg, CardText, CardBody, CardTitle, FormGroup, Label, Input, Button, Form } from 'reactstrap';
                ...
                <div className='col-12 col-sm-8' key={dish.id}>
                    ...
                    <Form>
                        <FormGroup>
                            ...
                            <Input type='text' id='author' name='author' placeholder='author' value={this.state.author} onChange={this.handleInputChange} />
                        </FormGroup>
                        <FormGroup>
                            <Label for="comment">comment:</Label>
                            <Input type='text' id='comment' name='comment' placeholder='comment' value={this.state.comment} onChange={this.handleInputChange} />
                        </FormGroup>
                        <FormGroup>
                            <Label for="rating">Rating:</Label>
                            <Input type='number' id='rating' name='rating' placeholder='rating' min='1' max='5' value={this.state.rating} onChange={this.handleInputChange} />
                        </FormGroup>
                        <FormGroup>
